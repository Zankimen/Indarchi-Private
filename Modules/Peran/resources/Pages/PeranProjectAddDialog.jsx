...
function PeranProjectAddDialog({ project, permissions }) {
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    post(`/projects/${project?.id}/peran`, {
      onSuccess: () => {
        reset();
        setOpen(false);
      },
  ...
  return (
    <Dialog open={open} onOpenChange={setOpen}>
      ...
      <DialogContent className="sm:max-w-[800px] border-border max-h-[90vh] overflow-y-auto">
        <DialogHeader>
            ...
            <div className="space-y-4">
              <Label className="text-foreground text-base block">
                ...
                <span className="text-sm text-muted-foreground font-normal ml-2">
                  (Permissions khusus untuk proyek lokal)
                </span>
              </Label>
...
export default PeranProjectAddDialog;
