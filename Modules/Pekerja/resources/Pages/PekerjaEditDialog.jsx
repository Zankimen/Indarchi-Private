...
function PekerjaEditDialog({ pekerja, perans }) {
      ...
      <DialogContent className="sm:max-w-[800px] border-border">
        ...
        <Card className="px-6 py-8 space-y-2 border-border">
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="space-y-2">
              <Label htmlFor="nama_pekerja" className="text-foreground text-base block">
                Nama pekerja
              </Label>
              <Input
                type="text"
            ...
            <div className="space-y-2">
              ...
              {errors.posisi && <p className="text-sm text-red-500">{errors.posisi}</p>}
            </div>
...
export default PekerjaEditDialog;